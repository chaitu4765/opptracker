...
OppTrack reads notification content

System checks whether message relates to an opportunity
...
The opportunity is organized and displayed in the dashboard

Users can bookmark opportunities or mark them as applied for easier tracking
